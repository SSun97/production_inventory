...
var addProductForm = document.querySelector('.form-addProduct'); // console.log(addProductForm);
// if (addProductForm) {
...
if (addProductForm) addProductForm.addEventListener('submit', function (e) {
  ...
  form.quantity = document.getElementById('product_qty').value; // form.city = 'New York';

  form.city = document.getElementById('product_city').value;
  form.description = document.getElementById('product_des').value; // form.append('name', document.getElementById('product_name').value);
